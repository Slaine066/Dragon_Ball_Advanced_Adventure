...
Stage1_1::Stage1_1() : m_dwGoTime(GetTickCount()), m_bShowGo(true)
{
}
...
void Stage1_1::Initialize()
{
	...
	TileManager::Get_Instance()->Set_EditorId(STAGE1_1);
